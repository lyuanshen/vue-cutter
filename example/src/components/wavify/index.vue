...
export default {
  ...
  data() {
    return {
      waveAllHeight: 150, //波浪的整体高度
      waveCount: 4, //波浪个数
      waveHeight: 45 //波浪起伏高度
    };
  },
  mounted() {
    this.wavePlay("wave1", 140, "hsl(0, 0.0%, 100.0%)", 1500);
    this.wavePlay("wave2", 140, "hsl(200, 100%, 100%)", 3000);
    this.wavePlay("wave3", 140, "hsl(170, 100%, 100%)", 2500);
  },
  methods: {
    //  * 底部波浪
